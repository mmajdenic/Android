	...
	implements IMediaPlayerThreadClient
{
	...
	public void startMediaPlayer()
	{
		...
		//set to foreground
		Notification notification = new Notification(android.R.drawable.ic_media_play, "Radio Stream",
		...
		notification.setLatestEventInfo(context, "Radio is  Playing..",
		        "Radio Stream", pendingIntent);
